describe AlphavantageAsDataframe::Fundamental do
  before do
  ...
  describe '#overview' do
    ...
    before do
      stub_request(:get, "https://www.alphavantage_as_dataframe.co/query?apikey=someKey&function=OVERVIEW&symbol=TSLA").
  ...
  describe '#earnings' do
    ...
    before do
      stub_request(:get, "https://www.alphavantage_as_dataframe.co/query?apikey=someKey&function=EARNINGS&symbol=TSLA").
  ...
  describe '#income_statement' do
    ...
    before do
      stub_request(:get, "https://www.alphavantage_as_dataframe.co/query?apikey=someKey&function=INCOME_STATEMENT&symbol=TSLA").
  ...
  describe '#balance_sheet' do
    ...
    before do
      stub_request(:get, "https://www.alphavantage_as_dataframe.co/query?apikey=someKey&function=BALANCE_SHEET&symbol=TSLA").
  ...
  describe '#cash_flow' do
    ...
    before do
      stub_request(:get, "https://www.alphavantage_as_dataframe.co/query?apikey=someKey&function=CASH_FLOW&symbol=TSLA").
